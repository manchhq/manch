...
## [0.0.1](https://github.com/manchhq/manch/releases/tag/manch-protocol-v0.0.1) - 2026-07-11

### Added

- *(protocol)* role-tagged Context with grouped turns
...
- *(llm)* extract shared SSE/list-models/error helpers; fix error bodies ([#22](https://github.com/manchhq/manch/pull/22))
